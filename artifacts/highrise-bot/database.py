...
def _migrate_db():
    ...
    for sql in [
        ...
        """CREATE TABLE IF NOT EXISTS raffles (
            id          INTEGER PRIMARY KEY AUTOINCREMENT,
            prize       TEXT NOT NULL DEFAULT 'Surprise Prize',
            status      TEXT NOT NULL DEFAULT 'active',
            created_at  TEXT NOT NULL DEFAULT (datetime('now')),
        ...
        """CREATE TABLE IF NOT EXISTS room_daily_stats (
            day_key          TEXT PRIMARY KEY NOT NULL DEFAULT '',
            unique_visitors  INTEGER NOT NULL DEFAULT 0,
            total_joins      INTEGER NOT NULL DEFAULT 0,
            peak_players     INTEGER NOT NULL DEFAULT 0
        )""",
        """CREATE TABLE IF NOT EXISTS room_daily_visitors (
            day_key TEXT NOT NULL DEFAULT '',
            user_id TEXT NOT NULL DEFAULT '',
        ...
        """CREATE TABLE IF NOT EXISTS farm_boosts (
            user_id      TEXT PRIMARY KEY NOT NULL DEFAULT '',
            username     TEXT NOT NULL DEFAULT '',
            expires_at   TEXT NOT NULL DEFAULT '',
            boost_minutes INTEGER NOT NULL DEFAULT 0,
        ...
        """CREATE TABLE IF NOT EXISTS hype_events (
            ...
            ts             TEXT NOT NULL DEFAULT (datetime('now')),
            muted_room     INTEGER NOT NULL DEFAULT 0,
