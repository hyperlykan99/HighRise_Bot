"""Radio V3 local favorite source acquisition."""
...
async def prepare(bot, request_id: int, fav: dict) -> None:
    ...
    try:
        ...
        safe_name = f"local_request_v3_{request_id}_{os.path.basename(source)}"
