...
REGISTRY: dict[str, Cmd] = {
    ...
    "unjail":                Cmd("security","jail",False,False,True,  perm="manager",
                                 aliases=("jailrelease",)),
    "jailadmin":             Cmd("security","jail",False,True, False, perm="admin"),
    "jailactive":            Cmd("security","jail",False,True, False, perm="admin"),
    "jailsetcost":           Cmd("security","jail",False,False,True,  perm="admin"),
    "jailsetmax":            Cmd("security","jail",False,False,True,  perm="admin"),
    "jailsetmin":            Cmd("security","jail",False,False,True,  perm="admin"),
    "jailsetbailmultiplier": Cmd("security","jail",False,False,True,  perm="admin"),
    "jailprotectstaff":      Cmd("security","jail",False,False,True,  perm="owner"),
    "jaildebug":             Cmd("security","jail",False,True, False, perm="owner"),
    "setjailspot":           Cmd("security","jail",False,False,True,  perm="admin"),
    "setjailguardspot":      Cmd("security","jail",False,False,True,  perm="admin"),
    "setsecurityidle":       Cmd("security","jail",False,False,True,  perm="admin"),
