...
REGISTRY: dict[str, Cmd] = {
    ...
    "staffbjhelp":      Cmd("blackjack","casino",False,False,True, perm="staff"),
    ...
    "leaderboard":      Cmd("banker","economy",False,True, False, aliases=("lb","top")),
    "toprich":          Cmd("banker","economy",False,True, False),
    "topminers":        Cmd("banker","economy",False,True, False),
    "topfishers":       Cmd("banker","economy",False,True, False),
    "topstreaks":       Cmd("banker","economy",False,True, False),
    ...
    "pokerguide":       Cmd("poker","casino",False,True, False),
    "pleave":           Cmd("poker","casino",False,False,True),
    "phand":            Cmd("poker","casino",False,True, False, aliases=("ph","cards","pcards")),
    ...
    "collection":       Cmd("miner","mining",False,True, False,
                            aliases=("mybook","collectbook")),
    "topcollectors":    Cmd("miner","mining",False,True, False,
    ...
    "minesummary":      Cmd("miner","mining",True, True, False),
    "autosummary":      Cmd("miner","mining",True, True, False),
    ...
    "buybadge":         Cmd("shopkeeper","shop",False,False,True),
    "badgeshop":        Cmd("shopkeeper","shop",False,True, False),
    "marketbadges":     Cmd("shopkeeper","shop",False,True, False),
    "sellbadge":        Cmd("shopkeeper","shop",False,False,True),
    "cancelbadge":      Cmd("shopkeeper","shop",False,False,True),
    "equipbadge":       Cmd("shopkeeper","shop",False,False,True),
    "staffbadge":       Cmd("shopkeeper","shop",False,False,True, perm="manager"),
    "emojitest":        Cmd("shopkeeper","shop",False,True, False, perm="owner"),
    "disableemoji":     Cmd("shopkeeper","shop",False,False,True, perm="owner"),
    "enableemoji":      Cmd("shopkeeper","shop",False,False,True, perm="owner"),
    # Market aliases (3.1F)
    "mylistings":       Cmd("shopkeeper","shop",False,True, False),
    "marketsearch":     Cmd("shopkeeper","shop",False,True, False),
    "marketfilter":     Cmd("shopkeeper","shop",False,True, False),
    "badgehelp":        Cmd("shopkeeper","shop",False,True, False),
    "helpbadge":        Cmd("shopkeeper","shop",False,True, False),
    "helpbadges":       Cmd("shopkeeper","shop",False,True, False),
    "helpmarket":       Cmd("shopkeeper","shop",False,True, False),
    "helptrade":        Cmd("shopkeeper","shop",False,True, False),
    "marketaudit":      Cmd("shopkeeper","shop",False,True, False, perm="admin"),
    "marketdebug":      Cmd("shopkeeper","shop",False,True, False, perm="admin"),
    "forcelistingcancel": Cmd("shopkeeper","shop",False,False,True, perm="admin"),
    "clearbadgelocks":  Cmd("shopkeeper","shop",False,False,True, perm="admin"),
    # Trade system (3.1F)
    "trade":            Cmd("shopkeeper","shop",False,False,True),
    "tradeadd":         Cmd("shopkeeper","shop",False,False,True),
    "tradecoins":       Cmd("shopkeeper","shop",False,False,True),
    "tradeview":        Cmd("shopkeeper","shop",False,True, False),
    "tradeconfirm":     Cmd("shopkeeper","shop",False,False,True),
    "tradecancel":      Cmd("shopkeeper","shop",False,False,True),
    "titles":           Cmd("shopkeeper","shop",False,True, False, aliases=("titleinfo",)),
    "titleshop":        Cmd("shopkeeper","shop",True, True, False),
    "mytitles":         Cmd("shopkeeper","shop",True, True, False),
    "buytitle":         Cmd("shopkeeper","shop",True, False,True),
    "equiptitle":       Cmd("shopkeeper","shop",True, False,True),
    "unequiptitle":     Cmd("shopkeeper","shop",True, False,True),
    "titlehelp":        Cmd("shopkeeper","shop",True, True, False),
    "myboosts":         Cmd("shopkeeper","shop",True, True, False, aliases=("perks","titleperks")),
    "alltitles":        Cmd("shopkeeper","shop",True, True, False),
    "titlesearch":      Cmd("shopkeeper","shop",True, True, False),
    "titleprogress":    Cmd("shopkeeper","shop",True, True, False),
    "claimtitles":      Cmd("shopkeeper","shop",True, False,True),
    ...
    "modlog":           Cmd("security","moderation",False,True, False, perm="staff",
                            aliases=("roomlogs",)),
    "softban":          Cmd("security","moderation",False,False,True, perm="manager",
                            aliases=("ecoban",)),
    "unsoftban":        Cmd("security","moderation",False,False,True, perm="manager",
                            aliases=("ecounban",)),
    "safetyadmin":      Cmd("security","admin",     False,True, False, perm="admin",
                            aliases=("antispam","spamadmin")),
    "economysafety":    Cmd("security","admin",     False,True, False, perm="admin",
                            aliases=("txsafety","economyalerts")),
    "safetydash":       Cmd("security","admin",     False,True, False, perm="admin",
                            aliases=("safedash","safetydashboard")),
    "mod":              Cmd("security","help",       True, True, False, perm="staff",
                            aliases=()),
    ...
    "failedemotes":     Cmd("dj","admin",  False, True,  True,  perm="manager"),
    ...
    "q":                Cmd("dj","music",  True, True,  False),
    "now":              Cmd("dj","music",  True, True,  False, aliases=("np",)),
    "np":               Cmd("dj","music",  True, True,  False),
    ...
    "djconfig":         Cmd("dj","music",  False,True,  False, perm="manager",
                            aliases=("djsettings",)),
    "djcheck":          Cmd("dj","music",  False,False, False, perm="admin"),
    ...
    "radiohelp":        Cmd("dj","music",  True, True,  False),
    "radiotest":        Cmd("dj","music",  False,True,  False, perm="staff"),
    "musicstatus":      Cmd("dj","music",  False,True,  False, perm="staff"),
    "setradio":         Cmd("dj","music",  False,False, False, perm="admin"),
    "radiostatus":      Cmd("dj","music",  True, True,  False),
    "webplayer":        Cmd("dj","music",  True, True,  False),
    "setwebplayer":     Cmd("dj","music",  False,False, False, perm="admin"),
    ...
    "songinfo":         Cmd("dj","music",  True, False, False),
    "recent":           Cmd("dj","music",  True, True,  False),
    "myrequests":       Cmd("dj","music",  True, False, False),
    "cancelrequest":    Cmd("dj","music",  True, False, False),
    "requeststatus":    Cmd("dj","music",  True, True,  False),
    "djstats":          Cmd("dj","music",  True, True,  False),
    "favorite":         Cmd("dj","music",  True, False, False),
    "favorites":        Cmd("dj","music",  True, True,  False),
    "playfavlocal":     Cmd("dj","music",  True, False, False),
    "localreplaytest":  Cmd("dj","music",  False,True,  False, perm="admin"),
    "localreplaystatus": Cmd("dj","music", False,True,  False, perm="admin"),
    "localreplaycleanup": Cmd("dj","music", False,False, False, perm="admin"),
    "musicshop":        Cmd("dj","music",  True, True,  False),
    "buydisc":          Cmd("dj","music",  True, False, False),
    "discs":            Cmd("dj","music",  True, False, False),
    "discprice":        Cmd("dj","music",  False,False, False, perm="staff"),
    "setdiscprice":     Cmd("dj","music",  False,False, False, perm="staff"),
    "requestdiscprice": Cmd("dj","music",  False,False, False, perm="staff"),
    "setrequestdisc":   Cmd("dj","music",  False,False, False, perm="staff"),
    "repeat":           Cmd("dj","music",  False,False, False, perm="admin"),
    ...
    "priorityqueue":    Cmd("dj","music",  True, True,  False, aliases=("pqueue",)),
    "moveup":           Cmd("dj","music",  False,False, False, perm="admin"),
    ...
    "fishsummary":       Cmd("fisher","fishing", True, True,  False),
    "fishluck":          Cmd("fisher","fishing", True, True,  False,
                             aliases=("fishstack",)),
    "fishadmin":         Cmd("fisher","fishing", True, False, True),
    "fishpanel":         Cmd("fisher","fishing", False,True,  False, perm="manager",
                             aliases=("fishingpanel",)),
    "setfishcooldown":   Cmd("fisher","fishing", False,False, True,  perm="manager"),
    "setfishweights":    Cmd("fisher","fishing", False,False, True,  perm="manager"),
    "setfishweightscale": Cmd("fisher","fishing",False,False, True,  perm="manager"),
    "setfishannounce":   Cmd("fisher","fishing", False,False, True,  perm="manager"),
    "setfishrarityweightrange": Cmd("fisher","fishing",False,False,True,perm="manager"),
    ...
    "toptippers":       Cmd("banker",  "economy", True,  True,  False, aliases=()),
    "toptipped":        Cmd("banker",  "economy", True,  True,  False, aliases=("toptipreceivers",)),
    "p2pgolddebug":     Cmd("banker",  "economy", False, False, True,  perm="owner"),
    ...
    "automod":               Cmd("security","moderation",False,False, True,  perm="manager"),
    ...
    # ── Luxe Jail — runtime commands (SecurityBot owns, no fallback) ─────────
    "jail":                  Cmd("security","jail",False,False,True,  perm="player"),
    "bail":                  Cmd("security","jail",False,False,True,  perm="player"),
    "jailstatus":            Cmd("security","jail",False,True, False, perm="player"),
    "jailtime":              Cmd("security","jail",False,True, False, perm="player"),
    "jailhelp":              Cmd("security","jail",False,True, False, perm="player"),
    "unjail":                Cmd("security","jail",False,False,True,  perm="manager",
                                 aliases=("jailrelease",)),
    "jailactive":            Cmd("security","jail",False,True, False, perm="admin"),
    "jailconfirm":           Cmd("security","jail",False,False,True,  perm="player"),
    "jailcancel":            Cmd("security","jail",False,False,False, perm="player"),
    # ── Luxe Jail — setup/admin (KeanuShield owns; fallback=True lets host assist) ─
    "jailadmin":             Cmd("security","jail",True, True, False, perm="admin"),
    "jaildebug":             Cmd("security","jail",True, True, False, perm="admin"),
    "jailsetcost":           Cmd("security","jail",True, False,True,  perm="admin"),
    "jailsetmax":            Cmd("security","jail",True, False,True,  perm="admin"),
    "jailsetmin":            Cmd("security","jail",True, False,True,  perm="admin"),
    "jailsetbailmultiplier": Cmd("security","jail",True, False,True,  perm="admin"),
    "jailprotectstaff":      Cmd("security","jail",True, False,True,  perm="owner"),
    "setjailspot":           Cmd("security","jail",True, False,True,  perm="admin"),
    "setjailguardspot":      Cmd("security","jail",True, False,True,  perm="admin"),
    "setsecurityidle":       Cmd("security","jail",True, False,True,  perm="admin"),
    "setjailreleasespot":    Cmd("security","jail",True, False,True,  perm="admin"),
    ...
    "economyalertdebug":     Cmd("host",    "room_admin",False,True,  False, perm="owner"),
    "securityalertdebug":    Cmd("host",    "room_admin",False,True,  False, perm="owner"),
    "playermodnotice":       Cmd("host",    "room_admin",False,True,  False, perm="owner"),
    "testgamealert":         Cmd("host",    "room_admin",False,True,  False, perm="owner"),
    "testeventalert":        Cmd("host",    "room_admin",False,True,  False, perm="owner"),
    ...
    "notifyreset":           Cmd("host",    "admin",   False, False, True,  perm="admin"),
    "notifyresetall":        Cmd("host",    "admin",   False, False, True,  perm="owner"),
    "confirmnotifyresetall": Cmd("host",    "admin",   False, False, True,  perm="owner"),
    ...
    "luxeshop":     Cmd("banker", "economy", True,  True,  False,
                        aliases=("premiumshop",)),
    "buyticket":    Cmd("banker", "economy", True,  False, True,
                        aliases=("buyluxe",)),
    ...
    "stafftools":     Cmd("host", "general",   False, True,  True,  perm="mod"),
    "staffnote":      Cmd("security", "admin", False, True,  True,  perm="mod"),
    "staffnotes":     Cmd("security", "admin", False, True,  True,  perm="mod"),
    "permissioncheck":Cmd("security", "admin", False, True,  True,  perm="mod"),
    "rolecheck":      Cmd("security", "admin", False, True,  True,  perm="mod"),
    ...
    "rcmode":         Cmd("host", "admin",     False, True,  False, perm="owner"),
    "production":     Cmd("host", "admin",     False, True,  False, perm="owner"),
    "featurefreeze":  Cmd("host", "admin",     False, True,  False, perm="owner"),
    "economylock":    Cmd("host", "admin",     False, True,  False, perm="owner"),
    "registrylock":   Cmd("host", "admin",     False, True,  False, perm="owner"),
    "releasenotes":   Cmd("host", "general",   True,  True,  True),
    "version":        Cmd("host", "general",   True,  True,  True,
                          aliases=("botversion",)),
    "botversion":     Cmd("host", "general",   True,  True,  True),
    "backup":         Cmd("host", "admin",     False, True,  False, perm="owner"),
    "rollbackplan":   Cmd("host", "admin",     False, True,  False, perm="admin"),
    "restorebackup":  Cmd("host", "admin",     False, True,  False, perm="owner"),
    "ownerchecklist": Cmd("host", "admin",     False, True,  False, perm="owner",
                          aliases=("launchownercheck",)),
    "launchownercheck": Cmd("host", "admin",   False, True,  False, perm="owner"),
    "launchannounce": Cmd("host", "admin",     False, True,  False, perm="admin"),
    "whatsnew":       Cmd("host", "general",   True,  True,  True,
                          aliases=("new", "v32")),
    "new":            Cmd("host", "general",   True,  True,  True),
    "v32":            Cmd("host", "general",   True,  True,  True),
    "knownissues":    Cmd("host", "general",   True,  True,  True),
