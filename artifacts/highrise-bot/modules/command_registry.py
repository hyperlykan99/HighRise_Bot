...
REGISTRY: dict[str, Cmd] = {
    ...
    # ── Luxe Jail — setup/admin commands (host handles, fallback=True) ───────
    "jailadmin":             Cmd("host",    "jail",True, True, False, perm="admin"),
    "jaildebug":             Cmd("host",    "jail",True, True, False, perm="admin"),
    "jailsetcost":           Cmd("host",    "jail",True, False,True,  perm="admin"),
    "jailsetmax":            Cmd("host",    "jail",True, False,True,  perm="admin"),
    "jailsetmin":            Cmd("host",    "jail",True, False,True,  perm="admin"),
    "jailsetbailmultiplier": Cmd("host",    "jail",True, False,True,  perm="admin"),
    "jailprotectstaff":      Cmd("host",    "jail",True, False,True,  perm="owner"),
