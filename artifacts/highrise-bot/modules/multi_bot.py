...
_DEFAULT_COMMAND_OWNERS: dict[str, str] = {
    ...
    "roomhelp": "host", "teleporthelp": "host",
    "alerthelp": "host", "welcomehelp": "host",
    ...
    "daily": "banker", "streak": "banker", "dailystatus": "banker",
    "leaderboard": "banker", "lb": "banker", "top": "banker",
    "toprich": "banker", "topminers": "banker", "topfishers": "banker", "topstreaks": "banker",
    "commandcheck": "host",
    ...
    "buycoins": "banker",
    "buypack": "banker", "packs": "banker", "buychillcoins": "banker",
    "coinpack": "banker", "coinpackadmin": "banker",
    "use": "banker",
    "luxeadmin": "banker",
    "vipadmin": "banker",
    "autoconvert": "banker",
    ...
    "claimdaily": "host",
    "claimweekly": "host",
    "milestones": "host", "collectionrewards": "host",
    "claimmilestone": "host",
    "xp": "host", "rank": "host",
    "season": "host", "topseason": "host", "seasonrewards": "host",
    ...
    "bjstatus": "blackjack", "bjforce": "blackjack", "bjtest": "blackjack", "blackjackhelp": "blackjack",
    ...
    "raise": "poker", "r": "poker",
    "fold": "poker", "f": "poker",
    "allin": "poker", "ai": "poker", "shove": "poker", "all-in": "poker",
    "join": "poker", "hand": "poker", "leave": "poker", "table": "poker",
    ...
    "missingtimings": "dj", "findemote": "dj", "emotetime": "dj",
    ...
    "emoteresolve": "dj", "emotediag": "dj", "unsupportedemotes": "dj",
    "markemoteworks": "dj", "markemoteunsupported": "dj",
    "scanallbotemotes": "dj", "pauseemotescan": "dj",
    "resumeemotescan": "dj", "stopemotescan": "dj",
    "scanprogress": "dj", "workingemotes": "dj", "exportworkingemotes": "dj",
    "autoconfirmedemotes": "dj", "sdkokemotes": "dj",
    ...
    "emotelog": "dj", "emotelogstatus": "dj", "lastemotes": "dj",
    "clearemotelog": "dj", "addobservedemote": "dj", "testobservedemote": "dj",
    "fakeemote": "dj", "debugemoteevents": "dj",
    ...
    "skip": "dj", "djskip": "dj",
    "skipvote": "dj",
    "radio": "dj", "radiostatus": "dj", "radiohealth": "dj",
    "radiotest": "dj", "musicstatus": "dj",
    "webplayer": "dj",
    "recent": "dj", "myrequests": "dj",
    "cancelrequest": "dj", "requeststatus": "dj",
    "songinfo": "dj",
    "djstatus": "dj", "djhistory": "dj", "toprequests": "dj", "upnext": "dj",
    "djstats": "dj", "djprice": "dj",
    "djleaderboard": "dj", "djtop": "dj",
    "priorityqueue": "dj", "pqueue": "dj",
    "favorite": "dj", "unfavorite": "dj", "favorites": "dj",
    "fav": "dj", "favnow": "dj", "favs": "dj",
    "myplaylist": "dj", "addtoplaylist": "dj",
    "removefavorite": "dj",
    "history": "dj", "radiohistory": "dj",
    "like": "dj", "dislike": "dj", "songrating": "dj",
    "topsongs": "dj", "toprequesters": "dj",
    "radiostats": "dj", "toplisteners": "dj",
    "topliked": "dj", "topdisliked": "dj",
    "radioachievements": "dj", "radioach": "dj", "radioawards": "dj",
    "tipdj": "dj",
    "djvibes": "dj",
    "djreport": "dj",
    "dedicate": "dj",
    ...
    "nowpage": "dj",
    # Staff / admin
    "setradio": "dj", "setwebplayer": "dj",
    "radioconfig": "dj", "setradiotype": "dj", "setradiomount": "dj", "setradiometadata": "dj",
    ...
    "playedrequests": "dj",
    "setrequestcost": "dj", "setprioritycost": "dj",
    "bantrack": "dj", "unbantrack": "dj",
    "banrequester": "dj", "unbanrequester": "dj",
    "queueadmin": "dj",
    "q": "dj", "radioqueue": "dj",
    "remove": "dj",
    "voteskip": "dj",
    ...
    "djset": "dj", "djdebug": "dj",
    "repeat": "dj", "shuffle": "dj", "autoplay": "dj",
    "setdjprice": "dj",
    "priorityplay": "dj", "prioritycost": "dj",
    ...
    "aeskip": "eventhost", "skipae": "eventhost", "skipaevent": "eventhost",
    ...
    "goldtip": "banker", "goldrain": "banker",
    "raingold": "banker", "goldstorm": "banker", "golddrop": "banker",
    ...
    "tele": "host", "create": "host", "delete": "host", "summon": "host",
    "tag": "host", "setrolespawn": "host", "rolespawn": "host",
    ...
    "softrestart": "host", "sub": "host", "subhelp": "host", "subscribe": "host",
    "substatus": "host", "testnotify": "host", "testnotifyall": "host",
    "toprep": "host", "unsub": "host", "unsubscribe": "host",
    "forcesub": "host", "fixsub": "host",
    "notifyon": "host", "notifyoff": "host",
    "xpleaderboard": "host",
    ...
    "profilebadge": "shopkeeper", "badgeprofile": "shopkeeper", "badgestatus": "shopkeeper",
    "showbadge": "shopkeeper", "flexbadge": "shopkeeper",
    "commonbadges": "shopkeeper", "rarebadges": "shopkeeper", "epicbadges": "shopkeeper",
    "legendarybadges": "shopkeeper", "mythicbadges": "shopkeeper",
    "wishlist": "shopkeeper", "wishbadge": "shopkeeper", "mywishlist": "shopkeeper",
    "badgewishlist": "shopkeeper", "removewishlist": "shopkeeper", "unwishlist": "shopkeeper",
    "giftbadge": "shopkeeper",
    "lockbadge": "shopkeeper", "unlockbadge": "shopkeeper", "lockedbadges": "shopkeeper",
    "confirmbuy": "shopkeeper", "cancelbuy": "shopkeeper",
    "claimbadge": "shopkeeper",
    "badgeaudit": "shopkeeper", "setbadgeconfirm": "shopkeeper",
    "equipbadge": "shopkeeper", "unequipbadge": "shopkeeper",
    "badge": "shopkeeper", "badgeshop": "shopkeeper", "allbadges": "shopkeeper",
    "badgelogs": "shopkeeper",
    "markethelp": "shopkeeper", "tradehelp": "shopkeeper",
    # Title V2 — player commands
    "titles": "shopkeeper", "titleshop": "shopkeeper", "alltitles": "shopkeeper",
    "mytitles": "shopkeeper", "titleinfo": "shopkeeper",
    "buytitle": "shopkeeper", "equiptitle": "shopkeeper", "unequiptitle": "shopkeeper",
    "titlesearch": "shopkeeper", "titleprogress": "shopkeeper",
    "claimtitles": "shopkeeper", "myboosts": "shopkeeper",
    "perks": "shopkeeper", "titleperks": "shopkeeper",
    "mystats": "shopkeeper", "prestige": "shopkeeper", "titlehelp": "shopkeeper",
    "loadout": "shopkeeper", "loadouts": "shopkeeper",
    "besttitle": "shopkeeper", "equipbest": "shopkeeper",
    "titlelb": "shopkeeper", "temporarytitles": "shopkeeper", "seasontitles": "shopkeeper",
    # Title V2 — admin commands
    "givetitle": "host", "removetitle": "host", "settitle": "host",
    "cleartitle": "host", "titleaudit": "host", "titlelogs": "host",
    "titlestats": "host", "boosts": "host",
    "addtitle": "host", "edittitle": "host", "edittitleperk": "host",
    "settitlebuyable": "host", "settitleactive": "host",
    "awardseasonaltitle": "host", "expiretitles": "host",
    ...
    "radio": "dj",
    "setradio": "dj", "radiostatus": "dj", "radiohealth": "dj",
    ...
    "djstats": "dj",
    "favorite": "dj", "unfavorite": "dj", "favorites": "dj",
    "fav": "dj", "favnow": "dj", "favs": "dj", "unfav": "dj",
    "myplaylist": "dj", "addtoplaylist": "dj",
    "playlist": "dj", "pl": "dj",
    "playfav": "dj",
    "playfavlocal": "dj", "localreplaytest": "dj",
    ...
    "autominesettings": "miner",
    "setautomine": "miner",
    "setautomineduration": "miner", "setautomineattempts": "miner",
    "setautominedailycap": "miner",
    # ── Fisher bot: fishing commands ─────────────────────────────────────────
    "fish": "fisher", "cast": "fisher", "reel": "fisher",
    "fishlist": "fisher", "fishrarity": "fisher",
    "fishprices": "fisher", "fishvalues": "fisher",
    "fishinfo": "fisher", "fishdetail": "fisher",
    "myfish": "fisher", "fishinv": "fisher",
    "sellfish": "fisher", "sellallfish": "fisher",
    "fishlevel": "fisher", "fishxp": "fisher", "fishlvl": "fisher",
    "fishstats": "fisher",
    ...
    "buyrod": "fisher", "purchaserod": "fisher",
    "equiprod": "fisher", "switchrod": "fisher",
    "rodinfo": "fisher", "roddetail": "fisher",
    "rodstats": "fisher", "rodupgrade": "fisher",
    "autofish": "fisher", "af": "fisher",
    "autofishstatus": "fisher", "afstatus": "fisher",
    "autofishsettings": "fisher",
    "setautofish": "fisher",
    ...
    "notifstatus": "host", "notifpreview": "host",
...
_HOST_AUDIT_CMDS: frozenset[str] = frozenset({
    ...
    "roomhelp", "teleporthelp", "alerthelp", "welcomehelp",
    "botmodehelp", "multibothelp", "maintenancehelp",
    "casinoadminhelp",
